...
app = QApplication([])
loder = QUiLoader()
main_window2 = loder.load("convert/start.ui")
main_window2.show()
main_window = loder.load("convert/main.ui")
...
def Fahrenheit_to_Celsius():
    ...
    if main_window2.Fahrenheit_to_Celsius.isChecked():
...
def Celsius_to_Kelvin():
    ...
    if main_window2.Celsius_to_Kelvin.isChecked():
...
def Fahrenheit_to_Kelvin():
    ...
    if main_window2.Fahrenheit_to_Kelvin.isChecked():
...
def Kelvin_to_Celsius():
    ...
    if main_window2.Kelvin_to_Celsius.isChecked():
...
def Foot_to_Inch():
    ...
    if main_window2.Foot_to_Inch.isChecked():
        f_i_set("0", "Foot", "Inch")
        main_window.show()
...
def Foot_to_Centimeter():
    ...
    if main_window2.Foot_to_Centimeter.isChecked():
...
def Foot_to_Meter():
    ...
    if main_window2.Foot_to_Meter.isChecked():
...
def Foot_to_Yard():
    ...
    if main_window2.Foot_to_Yard.isChecked():
        f_y_set("0", "Foot", "Yard")
        main_window.show()
...
def Euro_to_USD():
    ...
    if main_window2.Euro_to_USD.isChecked():
        e_u_set("0", "Euro", "USD")
        main_window.show()
...
def Euro_to_Cad():
    ...
    if main_window2.Euro_to_Cad.isChecked():
        e_c_set("0", "Euro", "Cad")
        main_window.show()
...
def Euro_to_Tnd():
    ...
    if main_window2.Euro_to_Tnd.isChecked():
        e_t_set("0", "Euro", "Tnd")
        main_window.show()
...
def Euro_to_Cnh():
    ...
    if main_window2.Euro_to_Cnh.isChecked():
        e_c_set("0", "Euro", "Cnh")
        main_window.show()

        main_window.convert.clicked.connect(partial(e_c_set, "-1", "Euro", "Cnh"))

main_window2.Fahrenheit_to_Celsius.toggled.connect(Fahrenheit_to_Celsius)
main_window2.Fahrenheit_to_Kelvin.toggled.connect(Fahrenheit_to_Kelvin)
main_window2.Celsius_to_Kelvin.toggled.connect(Celsius_to_Kelvin)
main_window2.Kelvin_to_Celsius.toggled.connect(Kelvin_to_Celsius)
main_window2.Foot_to_Inch.toggled.connect(Foot_to_Inch)
main_window2.Foot_to_Centimeter.toggled.connect(Foot_to_Centimeter)
main_window2.Foot_to_Meter.toggled.connect(Foot_to_Meter)
main_window2.Foot_to_Yard.toggled.connect(Foot_to_Yard)
main_window2.Euro_to_USD.toggled.connect(Euro_to_USD)
main_window2.Euro_to_Cad.toggled.connect(Euro_to_Cad)
main_window2.Euro_to_Tnd.toggled.connect(Euro_to_Tnd)
main_window2.Euro_to_Cnh.toggled.connect(Euro_to_Cnh)
