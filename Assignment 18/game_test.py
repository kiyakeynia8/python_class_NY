...
class Spaceship(arcade.Sprite):
    def __init__(self,Game,im=":resources:images/space_shooter/playerShip1_blue.png",y=70,a=0,ba=90):
        super().__init__(im)
        self.ba = ba
...
class MyGame(arcade.Window):
    def __init__(self, w, h, s):
        ...
        self.player_2 = Spaceship(self, ":resources:images/space_shooter/playerShip1_orange.png", SCREEN_HEIGHT-70, 180, -90)
